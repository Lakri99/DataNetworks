# Socket Programming 
Implementaion of File sharing application with MD5 hash check
...
**Execution details**
1. Start the server from the server directory (cd server)

```console
python serverTemplate.py
```
2. Start client from the client directory (cd client) with required command to execute
